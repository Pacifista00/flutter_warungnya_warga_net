...
class ElectronicProductSection extends StatefulWidget {
  const ElectronicProductSection({super.key});

  @override
  State<ElectronicProductSection> createState() =>
      _ElectronicProductSectionState();
}
...
class _ElectronicProductSectionState extends State<ElectronicProductSection> {
  ...
  void initState() {
    super.initState();
    _futureProducts = _datasource.getElectronicProducts();
  }
